...
import it.sauronsoftware.ftp4j.listparsers.*;
...
public class FTPClient {
     ...
     *
     * @param textualExtensionRecognizer The textual extension recognizer used by the client.
     * @see DefaultTextualExtensionRecognizer
     ...
     *                                  true).
     * @throws FTPIllegalReplyException If the server replies in an illegal way (can be thrown only
     ...
     * @throws IllegalStateException    If the client is not connected. Call the connect() method
     *                                  before!
     ...
     * @throws FTPIllegalReplyException If the server replies in an illegal way.
     * @throws FTPException             If the operation fails.
     * @throws FTPDataTransferException If a I/O occurs in the data transfer connection. If you
     ...
     * @throws FTPListParseException    If none of the registered parsers can handle the response
     *                                  sent by the server.
     * @see FTPListParser
     ...
     * FTPAbortedException.
     *
     * @param file The local file whose contents will be appended to the remote
     *             file.
     * @throws IllegalStateException    If the client is not connected or not authenticated.
     * @throws FileNotFoundException    If the supplied file cannot be found.
     * @throws IOException              If an I/O error occurs.
     ...
     * @throws FTPIllegalReplyException If the server reply to the ABOR command is illegal. This
     *                                  could happen only if force is false.
     */
